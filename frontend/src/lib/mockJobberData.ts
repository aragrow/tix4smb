...
export const MOCK_JOBS: JobberJob[] = [
  ...
  { id: 'j11', title: 'Move-In Clean',              jobStatus: 'completed',client: { id: 'c08', name: 'Patricia Johnson' },        property: { id: 'p08b', street: '120 Beachwood Cir',     city: 'Navarre' },        vendor: V('vd01','Maria Santos') },
  // p08c — no job
...
export const MOCK_VISITS: JobberVisit[] = [
  ...
  { id: 'v14', title: 'Move-In Clean',            scheduledStart: d(-3),  status: 'completed',  client: { id: 'c08', name: 'Patricia Johnson' },       property: { id: 'p08b', street: '120 Beachwood Cir',     city: 'Navarre' },        vendor: V('vd01','Maria Santos') },
