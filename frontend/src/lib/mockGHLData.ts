import type { GHLContact, GHLOpportunity, GHLAppointment } from '@/types';
...
export const MOCK_GHL_CONTACTS: GHLContact[] = [
...
export const MOCK_GHL_OPPORTUNITIES: GHLOpportunity[] = [
  ...
  { id: 'ghl-o05', name: "Bi-Weekly Residential — Sean O'Brien",   contact: { id: 'ghl-c05', name: "Sean O'Brien" },           pipelineStage: 'Active Client', monetaryValue: 160 },
  { id: 'ghl-o06', name: 'Weekly Clean — Denise Williams',         contact: { id: 'ghl-c06', name: 'Denise Williams' },        pipelineStage: 'Active Client', monetaryValue: 140 },
  { id: 'ghl-o07', name: 'One-Time Deep Clean — Miguel Garcia',    contact: { id: 'ghl-c07', name: 'Miguel Garcia' },          pipelineStage: 'Proposal Sent', monetaryValue: 400 },
  { id: 'ghl-o08', name: 'HOA Common Areas — Sunrise Villas',      contact: { id: 'ghl-c11', name: 'Sunrise Villas HOA' },     pipelineStage: 'Active Client', monetaryValue: 1200 },
  { id: 'ghl-o09', name: 'Turnover Cleaning Package — Coastal',    contact: { id: 'ghl-c12', name: 'Coastal Property Mgmt' },  pipelineStage: 'Active Client', monetaryValue: 900 },
  { id: 'ghl-o10', name: 'Rental Turnovers — Blue Water',          contact: { id: 'ghl-c13', name: 'Blue Water Rentals LLC' }, pipelineStage: 'Active Client', monetaryValue: 750 },
  { id: 'ghl-o11', name: 'Office Cleaning Contract — Emerald',     contact: { id: 'ghl-c14', name: 'Emerald Coast Offices' },  pipelineStage: 'Active Client', monetaryValue: 2000 },
  { id: 'ghl-o12', name: 'Residential Estimate — Marcus Taylor',   contact: { id: 'ghl-c15', name: 'Marcus Taylor' },          pipelineStage: 'Lead', monetaryValue: 175 },
];

export const MOCK_GHL_APPOINTMENTS: GHLAppointment[] = [
  ...
  { id: 'ghl-a06', title: 'Estimate Walkthrough',     contact: { id: 'ghl-c07', name: 'Miguel Garcia' },          startTime: d(3), status: 'new',       address: '3301 Davis Hwy, Pensacola' },
  { id: 'ghl-a07', title: 'Bi-Weekly Clean',          contact: { id: 'ghl-c09', name: 'Michael Anderson' },       startTime: d(5), status: 'confirmed', address: '900 Nine Mile Rd, Pensacola' },
  { id: 'ghl-a08', title: 'Turnover Clean',           contact: { id: 'ghl-c09', name: 'Michael Anderson' },       startTime: d(1), status: 'confirmed', address: '47 Pier Park Way, Panama City' },
  { id: 'ghl-a09', title: 'Clubhouse Weekly Clean',   contact: { id: 'ghl-c11', name: 'Sunrise Villas HOA' },     startTime: d(2), status: 'confirmed', address: '1 Sunrise Villas Clubhouse, Gulf Breeze' },
  { id: 'ghl-a10', title: 'Turnover Clean Unit A',    contact: { id: 'ghl-c12', name: 'Coastal Property Mgmt' },  startTime: d(3), status: 'confirmed', address: '410 Palafox St Unit A, Pensacola' },
  { id: 'ghl-a11', title: 'Rental Turnover Unit 1',   contact: { id: 'ghl-c13', name: 'Blue Water Rentals LLC' }, startTime: d(0), status: 'confirmed', address: '12 Gulf Shore Dr Unit 1, Destin' },
  { id: 'ghl-a12', title: 'Initial Estimate Call',    contact: { id: 'ghl-c15', name: 'Marcus Taylor' },          startTime: d(5), status: 'new',       address: '4520 Bayou Blvd, Pensacola' },
];
