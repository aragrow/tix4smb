...
const schema = z.object({
  ...
  GHL_CONTACT_CLASSIFICATION: z.string().default('vendor_status'),
  GHL_VENDOR_STATUS_VALUES: z.string().default('prospect,active'),
  GHL_VENDOR_STATUS_FIELD_ID: z.string().optional(),
