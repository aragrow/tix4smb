...
export const MOCK_GHL_CONTACTS = [
  { id: 'ghl-c01', name: 'Carmen Martinez',        email: 'carmen.m@email.com',       phone: '(850) 555-0101', classification: 'ACTIVE CLIENT',   tags: ['residential', 'weekly'] },
  { id: 'ghl-c02', name: 'Robert & Linda Thompson',email: 'rthompson@email.com',      phone: '(850) 555-0102', classification: 'ACTIVE CLIENT',   tags: ['residential', 'monthly'] },
  { id: 'ghl-c03', name: 'Wei Chen',               email: 'wei.chen@email.com',       phone: '(850) 555-0103', classification: 'ACTIVE CLIENT',   tags: ['residential', 'weekly'] },
  { id: 'ghl-c04', name: 'Priya Patel',            email: 'priya.patel@email.com',    phone: '(850) 555-0104', classification: 'ACTIVE CLIENT',   tags: ['vacation-rental'] },
  { id: 'ghl-c05', name: "Sean O'Brien",           email: 'sobrien@email.com',        phone: '(850) 555-0105', classification: 'ACTIVE CLIENT',   tags: ['residential'] },
  { id: 'ghl-c06', name: 'Denise Williams',        email: 'dwilliams@email.com',      phone: '(850) 555-0106', classification: 'ACTIVE CLIENT',   tags: ['residential'] },
  { id: 'ghl-c07', name: 'Miguel Garcia',          email: 'mgarcia@email.com',        phone: '(850) 555-0107', classification: 'ACTIVE CLIENT',   tags: ['lead'] },
  { id: 'ghl-c08', name: 'Patricia Johnson',       email: 'pjohnson@email.com',       phone: '(850) 555-0108', classification: 'ACTIVE CLIENT',   tags: ['residential', 'weekly'] },
  { id: 'ghl-c09', name: 'Michael Anderson',       email: 'manderson@email.com',      phone: '(850) 555-0109', classification: 'ACTIVE CLIENT',   tags: ['vacation-rental', 'bi-weekly'] },
  { id: 'ghl-c10', name: 'Thi Nguyen',             email: 'tnguyen@email.com',        phone: '(850) 555-0110', classification: 'ACTIVE CLIENT',   tags: ['commercial'] },
  { id: 'ghl-c11', name: 'Sunrise Villas HOA',     email: 'mgmt@sunrisevillas.com',   phone: '(850) 555-0114', classification: 'ACTIVE CLIENT',   tags: ['commercial', 'hoa'] },
  { id: 'ghl-c12', name: 'Coastal Property Mgmt',  email: 'ops@coastalprop.com',      phone: '(850) 555-0115', classification: 'ACTIVE CLIENT',   tags: ['commercial', 'property-mgmt'] },
